        ...
        <main id="article">
            <section class="list">
                <nav>
                    ...
                    <form action="/jboard/article/search.do"> <!-- searchType, keyword 전송 -->
                    <select name="searchType" style="padding: 6px;"> <!-- name="searchType"에 "value="title" 자동으로 묶여서 전송 -->
                        ...
                        <input type="text" name="keyword" value="${keyword}" placeholder="검색 키워드 입력"> <!-- name="keyword"에 input 사용자가 입력한 값 자동으로 묶여서 전송 -->
                ...
                <div class="page"> <!-- 검색조건을 유지하면서 페이지이동 하기 위해, searchType, keyword 다시 전송 -->
