...
<head>
    ...
    <script>
 	// 예전방식 - 댓글을 작성하면 onsubmit 실행 되면 form이 데이터 action으로 전송하고 sendRedirect로 새로고침하는 방식
	// 새로운 방식 - form 안쓰고 JavaScript onsubmit 실행 → 서버로 fetch 요청 → JSON 응답 → JavaScript가 화면에 댓글 추가
    	document.addEventListener('DOMContentLoaded', function(){
    		...
    		formComment.onsubmit = function(e){
    			e.preventDefault(); // onsubmit을 눌렀을때 form의 action(전송)되면서 sendRedirect(새로고침) 되는것을 막기 위해
    			...
    			.then(data => {
    				...
    				if(data != null){
    					...
    					formComment.content.value = ""; // 입력창 비우기
                ...
                <section class="commentForm">
                    ...
                    <form name="formComment" action="#">
                        ...
                        <div>
                            ...
                            <input type="submit" value="작성완료" class="btn btnComplete"/> <!-- onsubmit 실행, form의 데이터가 한번에 전송된다 -->
                        </div>
                    </form>
                </section>
